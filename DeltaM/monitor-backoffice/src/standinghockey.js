...
const Standinghockey_Filter = (props) => (
    <Filter {...props}>
...
export const StandinghockeyList = (props) => (
    <List {...props} filters={<Standinghockey_Filter />} >
        <Responsive
            small={
                <SimpleList
            ...
            medium={
                <Datagrid>
                    ...
                    <TextField source="wo" sortable={false} />
                    <TextField source="l" sortable={false} />
                    <TextField source="lo" sortable={false} />
