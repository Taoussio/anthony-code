...
class MaxButton extends Component {
    ...
    handleFound() {
        fetch(`${API_URL}/count/round/penalty?sport=${this.state.sport}&country=${this.state.country}&league=${this.state.league}${this.state.year !== null && this.state.year !== "" ? `&year=${this.state.year}` : ''}`, {}).then(res => res.json()).then(res => {
            this.setState({
    ...
    render() {
        ...
        return (
            <div className="container-fluid" style={{ display: "inline" }}>
                <FlatButton primary label="Penalty Series" onClick={this.handleOpen} icon={<ViewIcon />} />
                <Dialog
                    title="Penalty Series"
                            ...
                            <div>
                                <div>
                                    <TextField
                                        ...
                                        type="number"
                                        floatingLabelText="From Year To Now"
